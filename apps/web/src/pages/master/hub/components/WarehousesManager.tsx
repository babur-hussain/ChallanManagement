...
import { createWarehouseSchema } from '@textilepro/shared';
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center bg-card p-4 rounded-md border">
        ...
        <Button onClick={handleAddNew}><Plus className="mr-2 h-4 w-4" /> Add Warehouses</Button>
      </div>
      ...
      <FormModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={editingItem ? 'Edit Warehouse' : 'Add Warehouse'} isLoading={createMut.isPending || updateMut.isPending}>
